<section class="page-section portfolio bg-warning" id="portfolio">
    <div class="container">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-secondary mt-5 mb-3">Portfolio</h2>
        <!-- Icon Divider-->
        <div class="divider-custom">
            <div class="divider-custom-line"></div>
            <div class="divider-custom-icon"><i class="fa-solid fa-building-circle-check"></i></div>
            <div class="divider-custom-line"></div>
        </div>
